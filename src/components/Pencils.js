...
import './Pencils.css'; // Ensure the path is correct
import pencilsData from './Pencils.json'; // Ensure the path is correct
...
const Pencils = () => {
  ...
  return (
    <div className="pencils-container">
      ...
      <div className="pencils-grid">
        {pencilsData.map((item, index) => {
          const price = parsePrice(item.price);
          return (
            <div key={index} className="pencils-item">
              <img src={item.image} alt={item.name} className="pencils-image" />
              <h3 className="pencils-title">{item.name}</h3>
              <p className="pencils-description">{item.description}</p>
              <p className="pencils-price">
                ₹{!isNaN(price) ? price.toFixed(2) : 'N/A'}
              </p>
              <button
                className="pencils-button"
